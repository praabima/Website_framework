                        ...
                        <div class="panel-body">
                            <div class="form">
                                ...
                                <div class="form-group">
                                    <label for="name" class="control-label col-lg-2">Nama Perusahaan <span
                                        class="required">*</span></label>
                                        <div class="col-lg-10">
                                            <input class="form-control" name="nama" id="name" minlength="5" type="text"
                                ...
                                <div class="form-group">
                                    <label for="jabatan" class="control-label col-lg-2">Jabatan <span
                                        class="required">*</span></label>
                                        <div class="col-lg-10">
                                            <input class="form-control" name="jabatan" id="jabatan" minlength="2" type="text"
